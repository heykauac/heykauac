# Olá, eu sou o Kauã! 👋 (`@heykauac`)

<p align="center">
  <img src="https://github.com/heykauac.png" alt="Foto de Perfil de Kauã" width="180px" style="border-radius: 50%;" />
</p>
...
* 🎯 **Foco atual:** Expandir meus conhecimentos em desenvolvimento focado em segurança e performance.

---

### 🧠 Áreas de Interesse
* 🛡️ **Cyber Security:** Pentest, segurança da informação e mitigação de vulnerabilidades.
* 💻 **Software Development:** Criação de aplicações eficientes de ponta a ponta.
* 🤖 **Sistemas Embarcados:** Automação e projetos de hardware/software integrados.

---

### 🛠️ Minhas Tecnologias & Ferramentas
Aqui estão as linguagens e tecnologias com as quais trabalho, estudo e desenvolvo meus projetos:
